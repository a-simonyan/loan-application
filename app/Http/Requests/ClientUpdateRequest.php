...
class ClientUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'first_name' => 'required',
            'last_name' => 'required',
            'email' => 'nullable|required_without:phone_number|email|unique:clients,email,'.$this->id,
            'phone_number' => 'nullable|required_without:email|numeric|min:9|unique:clients,phone_number,'.$this->id,
